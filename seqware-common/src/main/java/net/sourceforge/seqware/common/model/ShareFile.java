...
public class ShareFile implements java.io.Serializable {
     ...
     *            a {@link java.util.Date} object.
     */
    public ShareFile(int shareFileId, File file, Registration registration, Boolean active, Integer swAccession, Date createTstmp,
            Date updateTstmp) {
        this.shareFileId = shareFileId;
        this.file = file;
        this.registration = registration;
    ...
    /**
     * <p>
     * Getter for the field <code>shareFileId</code>.
     * </p>
     * 
     * @return a int.
     */
    ...
    /**
     * <p>
     * Setter for the field <code>shareFileId</code>.
     * </p>
     * 
     * @param shareFileId
     *            a int.
