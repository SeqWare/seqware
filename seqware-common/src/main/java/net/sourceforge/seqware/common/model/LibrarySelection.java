...
public class LibrarySelection implements Serializable, Comparable<LibrarySelection>, SecondTierModel {
    ...
    public String toString() {
        return new StringBuilder().append("LibrarySelection ").append(librarySelectionId).append(":\t").append(name).append("\t")
    ...
    /**
     * <p>
     * Getter for the field <code>librarySelectionId</code>.
     * </p>
     * 
    ...
    /**
     * <p>
     * Setter for the field <code>librarySelectionId</code>.
     * </p>
     * 
