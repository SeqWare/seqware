...
/**
 * Takes in a fileName String or File object that we want to create a lockfile for
 * 
...
public class SimpleFileLock {
    ...
    /**
     * <p>
     * Constructor for SimpleFileLock.
     * </p>
     * 
     * @param fileName
    ...
    /**
     * Lock file, but give option to free lock when the JVM exits. Avoids dead locks if lock holder fails.
     * 
     * @param freeOnExit
     *            a boolean.
     * @return a boolean.
