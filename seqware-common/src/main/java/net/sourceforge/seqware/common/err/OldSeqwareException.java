...
/**
 * This exception wraps the old seqware exception code User: Xiaoshu Wang (xiao@renci.org) Date: 9/6/11 Time: 2:38 PM
 * 
 * @author boconnor
 * @version $Id: $Id
 */
public class OldSeqwareException extends SeqwareException {
    ...
    /**
     * <p>
     * Setter for the field <code>exitCode</code>.
     * </p>
     * 
     * @param exitCode
     *            a int.
    ...
    /**
     * <p>
     * Constructor for OldSeqwareException.
     * </p>
     */
