...
public class ShareSample implements java.io.Serializable {
     ...
     *            a {@link java.util.Date} object.
     */
    public ShareSample(int shareSampleId, Sample sample, Registration registration, Boolean active, Integer swAccession, Date createTstmp,
            Date updateTstmp) {
        this.shareSampleId = shareSampleId;
        this.sample = sample;
        this.registration = registration;
    ...
    /**
     * <p>
     * Getter for the field <code>shareSampleId</code>.
     * </p>
     * 
     * @return a int.
     */
    ...
    /**
     * <p>
     * Setter for the field <code>shareSampleId</code>.
     * </p>
     * 
     * @param shareSampleId
     *            a int.
