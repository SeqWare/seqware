...
public class ShareStudy implements Serializable, Comparable<ShareStudy> {
    ...
    public int compareTo(ShareStudy that) {
        ...
        if (that.getShareStudyId() == null) return -1; // when only the other name is null
    ...
    public String toString() {
        return new ToStringBuilder(this).append("shareStudyId", getShareStudyId())
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(getShareStudyId()).toHashCode();
    }

    /**
     * <p>
     * Getter for the field <code>shareStudyId</code>.
     * </p>
     * 
    ...
    /**
     * <p>
     * Setter for the field <code>shareStudyId</code>.
     * </p>
     * 
     * @param shareStudyId
