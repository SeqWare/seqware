...
public class ShareLane implements java.io.Serializable {
     ...
     *            a {@link java.util.Date} object.
     */
    public ShareLane(int shareLaneId, Lane lane, Registration registration, Boolean active, Integer swAccession, Date createTstmp,
            Date updateTstmp) {
        this.shareLaneId = shareLaneId;
        this.lane = lane;
        this.registration = registration;
    ...
    /**
     * <p>
     * Getter for the field <code>shareLaneId</code>.
     * </p>
     * 
     * @return a int.
     */
    ...
    /**
     * <p>
     * Setter for the field <code>shareLaneId</code>.
     * </p>
     * 
     * @param shareLaneId
     *            a int.
