...
public interface SampleReportService {
     ...
     * @return a {@link java.util.List} object.
     */
    List<SequencerRunReportId> getSequencerRunReportIds(SequencerRun seqRun, String sortField, String sortOrder, int offset, int limit);
