...
public class Study extends PermissionsAware implements Serializable, ParentAccessionModel, Comparable<Study> {
    ...
    public String toString() {
        return "Study{" + "studyId=" + studyId + ", swAccession=" + swAccession + ", title=" + title + ", description=" + description
                + ", alias=" + alias + ", accession=" + accession + ", status=" + status + ", abstractStr=" + abstractStr + ", newType="
                + newType + ", centerName=" + centerName + ", centerProjectName=" + centerProjectName + ", projectId=" + projectId
                + ", createTimestamp=" + createTimestamp + ", updateTimestamp=" + updateTimestamp + ", isSelected=" + isSelected
                + ", isHasFile=" + isHasFile + ", html=" + html + ", owner=" + owner + ", existingType=" + existingType
                + ", existingTypeInt=" + existingTypeInt + '}';
    }
    ...
    public boolean givesPermissionInternal(Registration registration, Set<Integer> considered) {
        ...
        if (!hasPermission) {
            throw new SecurityException("User " + registration.getEmailAddress() + " does not have permission to modify aspects of study "
                    + toString());
        }
