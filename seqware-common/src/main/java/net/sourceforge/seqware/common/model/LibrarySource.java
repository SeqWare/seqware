...
public class LibrarySource implements Serializable, Comparable<LibrarySource>, SecondTierModel {
    ...
    public String toString() {
        return new StringBuilder().append("LibrarySource ").append(librarySourceId).append(":\t").append(name).append("\t")
    ...
    /**
     * <p>
     * Getter for the field <code>librarySourceId</code>.
     * </p>
     * 
    ...
    /**
     * <p>
     * Setter for the field <code>librarySourceId</code>.
     * </p>
     * 
