...
public class HBaseTest {
	...
	ht.addFamily( new HColumnDescriptor( "myLittleFamily" ) ); // from and to
	HBaseAdmin hba = new HBaseAdmin(config);
        if(hba.isTableAvailable(MY_LITTLE_H_BASE_TABLE)){
	...
	hba.createTable( ht );
        ...
        HTable table = new HTable(config, MY_LITTLE_H_BASE_TABLE);
