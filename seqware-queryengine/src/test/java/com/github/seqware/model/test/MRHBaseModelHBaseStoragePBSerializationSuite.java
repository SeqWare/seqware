...
public class MRHBaseModelHBaseStoragePBSerializationSuite {
    ...
    public static void setupSuite() {
        Logger.getLogger(MRHBaseModelHBaseStoragePBSerializationSuite.class.getName()).log(Level.INFO, "Running test suite with HBase-aware objects using Protobuf serialization to HBase");
