...
public class MRHBaseModelHBaseStoragePBSerializationSuite {
    ...
    public static void setupSuite() {
        Logger.getLogger(MRHBaseModelHBaseStoragePBSerializationSuite.class.getName()).log(Level.INFO, "Running test suite with HBase-aware+MapReduce objects using Protobuf serialization to HBase");
    ...
    public static void tearDownSuite() {
        Logger.getLogger(MRHBaseModelHBaseStoragePBSerializationSuite.class.getName()).log(Level.INFO, "Ending test suite and resetting");
