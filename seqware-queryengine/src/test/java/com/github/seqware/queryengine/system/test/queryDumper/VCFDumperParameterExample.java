 ...
 */
package com.github.seqware.queryengine.system.test.queryDumper;
...
public class VCFDumperParameterExample implements QueryDumperInterface{
    ...
    public QueryFuture<FeatureSet> getQuery(FeatureSet set, int queryNum) {
        if (queryNum == 0){
            ...
            return SWQEFactory.getQueryInterface().getFeaturesByAttributes(0, set, new RPNStack(new RPNStack.TagOccurrence("tag set", "non_synonymous_codon")));
        }
    }
