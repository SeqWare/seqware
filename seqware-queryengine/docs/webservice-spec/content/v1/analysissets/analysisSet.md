---
title: Analysis Set | Generic Feature Store API
---

# Analysis Set API

Analysis Set resources group related analysis events. For example, all calls to a particular plugin may create analysis events that are grouped together in one analysis set.
...
Gets a list of analysis sets, this lists all groups of analysis events.
