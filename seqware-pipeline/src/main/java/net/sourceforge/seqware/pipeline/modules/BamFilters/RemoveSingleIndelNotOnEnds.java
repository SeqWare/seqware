...
public class RemoveSingleIndelNotOnEnds extends Module {
  ...
  public ReturnValue do_verify_parameters() {
    ...
    for ( String arg : new String[]{ "fasta", "input", "output", "filter-script", "perl-path" } ) {
      if (! options.has(arg)) {
  ...
  public ReturnValue do_run() {
    ...
    cmd.append(options.valueOf("perl-path") + " " + options.valueOf("filter-script") + " " + options.valueOf("input") + " " + options.valueOf("output") + " " + options.valueOf("fasta") );
