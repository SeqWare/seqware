...
import net.sourceforge.seqware.pipeline.plugins.batchmetadatainjection.BatchMetadataParser;
import net.sourceforge.seqware.pipeline.plugins.batchmetadatainjection.CreateFromScratch;
