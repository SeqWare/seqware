...
public class Main {
  ...
  // COMMANDS:
    ...
    public static void main(String[] argv) throws IOException {
        ...
        //completors.add(new SimpleCompletor(new String[]{"annotate", "bundle", "copy", "create", 
        //    "files", "study", "workflow", "workflow-run", "checkdb"
        //}));
        //reader.addCompletor(new ArgumentCompletor(completors));
        List<Completor> listCompletors = new ArrayList<>();
        reader.addCompletor(new SimpleCompletor(new String[]{"annotate", "bundle", "copy", "create", 
            "files", "study", "workflow", "workflow-run", "checkdb"}));
        listCompletors.add (new SimpleCompletor (new String [] { "annotate"}));
        listCompletors.add (new SimpleCompletor (new String [] { "experiment", "file", "ius"
            ,"lane","processing","sample","sequencer-run","study","workflow","workflow-run"}));
        reader.addCompletor(new ArgumentCompletor(listCompletors));
        ...
        while ((line = readLine(reader, "")) != null) {
            ...
            List<String> args = new ArrayList<>(Arrays.asList((String[])line.split(" ")));
            System.out.println("Passing: " + args.toString());
            if (flag(args, "--debug")) {
                DEBUG.set(true);
            }
    ...
    public static String readLine(ConsoleReader reader, String promptMessage)
            throws IOException {
