...
@PrepareForTest({io.seqware.cli.Main.class,net.sourceforge.seqware.pipeline.runner.PluginRunner.class,
	io.seqware.pipeline.plugins.WorkflowLifecycle.class,
	net.sourceforge.seqware.common.util.configtools.ConfigTools.class,
	net.sourceforge.seqware.common.metadata.Metadata.class,
	net.sourceforge.seqware.common.metadata.MetadataFactory.class})
...
public class WorkflowRunTest {
	...
	class WriteFormattedMessageToBufferAnswer implements Answer<Object>
	{
		...
		public Object answer(InvocationOnMock invocation) throws Throwable {
			errBuff = String.format((String) invocation.getArguments()[0], Arrays.copyOfRange(invocation.getArguments(), 1, invocation.getArguments().length));
	...
	public void testWorkflowRunINI() throws Exception
	{
		...
		String[] runnerArgs = {"--plugin", "net.sourceforge.seqware.pipeline.plugins.BundleManager", "--", "--list-workflow-params", "--workflow-accession", "12345"};
	...
	private void testWithError(String[] mainArgs, String errorMessage) throws Exception
	{
		...
		PowerMockito.doAnswer(new WriteFormattedMessageToBufferAnswer()).when(Main.class, "kill", anyString(), Matchers.<Object>anyVararg());
		try
		{
			Main.main(mainArgs);
		}
