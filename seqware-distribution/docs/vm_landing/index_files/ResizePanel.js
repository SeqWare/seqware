...
YAHOO.widget.ResizePanel.prototype.init = function(el, userConfig) {
	...
	this.resizeHandle.style.height = "20px";
	...
	this.resizeHandle.style.background = "url(i/bg/ico_win_r.png)";
	...
	this.renderEvent.subscribe(function() {
		...
		this.ddResize.onDrag = function(e) {
			...
			var buttonsHeight = 33; // prev, next, stop, home

			var bodyHeight = (newHeight - 10 - buttonsHeight - me.footer.offsetHeight - me.header.offsetHeight - 3);
			if (bodyHeight < 0) {
				bodyHeight = 0;
			}
