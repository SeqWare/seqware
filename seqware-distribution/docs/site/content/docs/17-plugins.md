...
|--workflow-engine|Optional: Specifies a workflow engine, we support Oozie (--workflow-engine oozie) and Pegasus (--workflow-engine pegasus) as our workflow engines with the default being Pegasus.|
