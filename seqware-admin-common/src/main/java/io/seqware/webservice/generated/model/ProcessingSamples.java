...
public class ProcessingSamples implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if ((this.processingSamplesId == null && other.processingSamplesId != null)
                || (this.processingSamplesId != null && !this.processingSamplesId.equals(other.processingSamplesId))) {
            return false;
        }
        return true;
    }
