...
public class SampleAttribute implements Serializable {
    ...
    @Id
    @SequenceGenerator(name="sample_attribute_sample_attribute_id_seq", allocationSize=1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE,generator="sample_attribute_sample_attribute_id_seq")
    ...
    public boolean equals(Object object) {
        ...
        if ((this.sampleAttributeId == null && other.sampleAttributeId != null)
                || (this.sampleAttributeId != null && !this.sampleAttributeId.equals(other.sampleAttributeId))) {
            return false;
        }
        return true;
    }
