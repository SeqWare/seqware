...
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "ShareStudy.findAll", query = "SELECT s FROM ShareStudy s"),
...
public class ShareStudy implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if ((this.shareStudyId == null && other.shareStudyId != null)
                || (this.shareStudyId != null && !this.shareStudyId.equals(other.shareStudyId))) {
            return false;
        }
        return true;
    }
