...
public class ProcessingRelationship implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if ((this.processingRelationshipId == null && other.processingRelationshipId != null)
                || (this.processingRelationshipId != null && !this.processingRelationshipId.equals(other.processingRelationshipId))) {
            return false;
        }
        return true;
    }
