...
public class ExperimentSpotDesign implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if ((this.experimentSpotDesignId == null && other.experimentSpotDesignId != null)
                || (this.experimentSpotDesignId != null && !this.experimentSpotDesignId.equals(other.experimentSpotDesignId))) {
            return false;
        }
        return true;
    }
