...
public class SequencerRunAttribute implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if ((this.sequencerRunAttributeId == null && other.sequencerRunAttributeId != null)
                || (this.sequencerRunAttributeId != null && !this.sequencerRunAttributeId.equals(other.sequencerRunAttributeId))) {
            return false;
        }
        return true;
    }
