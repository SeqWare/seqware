...
public class WorkflowParamValue implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if ((this.workflowParamValueId == null && other.workflowParamValueId != null)
                || (this.workflowParamValueId != null && !this.workflowParamValueId.equals(other.workflowParamValueId))) {
            return false;
        }
        return true;
    }
