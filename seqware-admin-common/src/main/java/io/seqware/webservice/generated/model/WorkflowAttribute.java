...
public class WorkflowAttribute implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if ((this.workflowAttributeId == null && other.workflowAttributeId != null)
                || (this.workflowAttributeId != null && !this.workflowAttributeId.equals(other.workflowAttributeId))) {
            return false;
        }
        return true;
    }
