...
import io.seqware.webservice.generated.model.ProcessingAttribute;
 ...
 */
@Stateless
@Path("io.seqware.webservice.model.processingattribute")
public class ProcessingAttributeFacadeREST extends AbstractFacade<ProcessingAttribute> {
  ...
  public ProcessingAttributeFacadeREST() {
    super(ProcessingAttribute.class);
  }
  ...
  public ProcessingAttribute find(@PathParam("id") Integer id) {
  ...
  @Path("{from}/{to}")
  @Produces({"application/xml", "application/json"})
  public List<ProcessingAttribute> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
