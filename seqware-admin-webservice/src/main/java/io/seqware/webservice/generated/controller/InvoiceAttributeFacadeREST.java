...
import io.seqware.webservice.generated.model.InvoiceAttribute;
...
public class InvoiceAttributeFacadeREST extends AbstractFacade<InvoiceAttribute> {
  ...
  public InvoiceAttributeFacadeREST() {
    super(InvoiceAttribute.class);
  }
  ...
  public InvoiceAttribute find(@PathParam("id") Integer id) {
  ...
  @Path("{from}/{to}")
  @Produces({"application/xml", "application/json"})
  public List<InvoiceAttribute> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
