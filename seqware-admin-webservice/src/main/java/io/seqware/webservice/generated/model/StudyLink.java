...
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "StudyLink.findAll", query = "SELECT s FROM StudyLink s"),
...
public class StudyLink implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if ((this.studyLinkId == null && other.studyLinkId != null)
                || (this.studyLinkId != null && !this.studyLinkId.equals(other.studyLinkId))) {
            return false;
        }
        return true;
    }
