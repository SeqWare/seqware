...
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "SampleLink.findAll", query = "SELECT s FROM SampleLink s"),
...
public class SampleLink implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if ((this.sampleLinkId == null && other.sampleLinkId != null)
                || (this.sampleLinkId != null && !this.sampleLinkId.equals(other.sampleLinkId))) {
            return false;
        }
        return true;
    }
