...
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "ShareFile.findAll", query = "SELECT s FROM ShareFile s"),
...
public class ShareFile implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if ((this.shareFileId == null && other.shareFileId != null)
                || (this.shareFileId != null && !this.shareFileId.equals(other.shareFileId))) {
            return false;
        }
        return true;
    }
