...
import io.seqware.webservice.generated.model.WorkflowAttribute;
 ...
 */
@Stateless
@Path("io.seqware.webservice.model.workflowattribute")
public class WorkflowAttributeFacadeREST extends AbstractFacade<WorkflowAttribute> {
  ...
  public WorkflowAttributeFacadeREST() {
    super(WorkflowAttribute.class);
  }
  ...
  public WorkflowAttribute find(@PathParam("id") Integer id) {
  ...
  @Path("{from}/{to}")
  @Produces({"application/xml", "application/json"})
  public List<WorkflowAttribute> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
