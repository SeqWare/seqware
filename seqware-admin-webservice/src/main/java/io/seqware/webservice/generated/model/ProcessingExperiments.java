...
public class ProcessingExperiments implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if ((this.processingExperimentsId == null && other.processingExperimentsId != null)
                || (this.processingExperimentsId != null && !this.processingExperimentsId.equals(other.processingExperimentsId))) {
            return false;
        }
        return true;
    }
