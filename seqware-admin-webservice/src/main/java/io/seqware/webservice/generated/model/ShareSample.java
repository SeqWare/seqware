...
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "ShareSample.findAll", query = "SELECT s FROM ShareSample s"),
...
public class ShareSample implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if ((this.shareSampleId == null && other.shareSampleId != null)
                || (this.shareSampleId != null && !this.shareSampleId.equals(other.shareSampleId))) {
            return false;
        }
        return true;
    }
