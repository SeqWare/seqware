...
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "ShareLane.findAll", query = "SELECT s FROM ShareLane s"),
...
public class ShareLane implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if ((this.shareLaneId == null && other.shareLaneId != null)
                || (this.shareLaneId != null && !this.shareLaneId.equals(other.shareLaneId))) {
            return false;
        }
        return true;
    }
