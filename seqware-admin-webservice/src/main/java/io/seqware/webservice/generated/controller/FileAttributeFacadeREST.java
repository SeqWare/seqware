...
import io.seqware.webservice.generated.model.FileAttribute;
 ...
 */
@Stateless
@Path("io.seqware.webservice.model.fileattribute")
public class FileAttributeFacadeREST extends AbstractFacade<FileAttribute> {
  ...
  public FileAttributeFacadeREST() {
    super(FileAttribute.class);
  }
  ...
  public FileAttribute find(@PathParam("id") Integer id) {
  ...
  @Path("{from}/{to}")
  @Produces({"application/xml", "application/json"})
  public List<FileAttribute> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
