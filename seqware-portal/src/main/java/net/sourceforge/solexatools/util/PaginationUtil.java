...
public class PaginationUtil {
    ...
    private static <T extends Object> List<T> subListImpl(HttpServletRequest request, String namePage, int sizeCount, List<T> list) {
     ...
     * @return a {@link java.util.List} object.
     */
    public static <T extends Object> List<T> subList(HttpServletRequest request, String namePage, int sizeCount, List<T> list) {
     ...
     *            a {@link java.lang.String} object.
     * @param ma
     *            a {@link org.springframework.context.support.MessageSourceAccessor} object.
     * @return a {@link net.sourceforge.solexatools.util.PageInfo} object.
     */
    public static PageInfo getPageInfo(HttpServletRequest request, String namePage, List listView, List listAll, String nameNode,
            String nameNodes, MessageSourceAccessor ma) {
     ...
     * @return a {@link net.sourceforge.solexatools.util.PageInfo} object.
     */
    public static PageInfo getPageInfoSD(HttpServletRequest request, String namePage, List listView, List allList, MessageSourceAccessor ma) {
        return getPageInfoImpl(request, namePage, listView.size(), allList.size(), SIZE_COUNT_FILE, ma);
    }

    private static PageInfo getPageInfoImpl(HttpServletRequest request, String namePage, int countView, int countAll, int countPage,
