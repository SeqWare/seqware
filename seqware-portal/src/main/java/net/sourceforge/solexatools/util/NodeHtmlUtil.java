...
public class NodeHtmlUtil {
     ...
     */
    public static String getWorkflowRunHtml(WorkflowRun workflowRun, Registration registration, String typeTree, String openingNodeId,
            String treeType) {
        String html = "";
        ...
        String closeOpenHtml = "' class='" + classLiHtml + "'><div class='hitarea hasChildren-hitarea expandable-hitarea'></div>";
        if (openingNodeId != null && openingNodeId.equals(Constant.WORKFLOW_RUN_PREFIX + workflowRunId)) {
            ...
            closeOpenHtml = "' class='" + classLiHtml + "'><div class='hitarea hasChildren-hitarea collapsable-hitarea'></div>";
        }

        html = "<li id='liwfrs_" + workflowRunId + closeOpenHtml + "<span>Associated IUSs</span><ul style='display: none;'></ul></li>";
        ...
        for (Processing children : processings) {
            ...
            if (openingNodeId != null && openingNodeId.equals(Constant.PROCESSING_PREFIX + children.getProcessingId())) isOpenProc = true;

            String aeHtml = getNodeHtml(children, registration, typeTree, true, isOpenProc, true, false, isLast(countItem), treeType);
    ...
    public static String getWorkflowRunHtmlWithIUSs(WorkflowRun workflowRun, Registration registration, String typeTree,
        ...
        for (IUS ius : iuss) {
            countItem--;
            html = html + getOnlyIUSHtml(ius, registration, typeTree, openingNodeId, true, true, true, isLast(countItem), treeType);
        }
        return html;
    }
     ...
     * @return a {@link java.lang.String} object.
     */
    public static String getProcessingHtml(Processing processing, Registration registration, String typeTree, String openingNodeId,
            String treeType) {
        String html = "";
        ...
        for (File file : files) {
            ...
            String fileLinkHtml = "File: <a href='downloader.htm?fileId=" + fileId + "'> " + name + "</a> SWID: " + swAccession;
     ...
     * @return a {@link java.lang.String} object.
     */
    public static String getAnalysisWorkflowHtml(WorkflowRun workflowRun, Registration registration, String typeTree, boolean isOpen,
            boolean isLast, String treeType) {
        String html = "";
        ...
        if (treeType.equals("tree")) {
            html = closeOpenHtml
                    ...
                    + linksHtml + "</span> " + "<span class='m-description'>Description: " + desc + "</span>" + END_HTML_EMPTY_NODE;
        } else {
            html = closeOpenHtml + "<span id='wfr_" + wfrId + "'>Analysis Workflow" + name + "</span>  " + END_HTML_EMPTY_NODE;
        }
        return html;
    }
     ...
     * @return a {@link java.lang.String} object.
     */
    public static String getNodeHtml(Processing processing, Registration registration, String typeTree, boolean isOpenWfr,
            boolean isOpenProc, boolean isVisibleProc, boolean isInnerWFR, boolean isLastNode, String treeType) {
        String html = "";
        ...
        if (registration.equals(processing.getOwner()) || registration.isLIMSAdmin()) {
            ...
            String deleteLink = "";
            String uploadFileLink = "<a href='uploadFileSetup.htm?id=" + aeId + "&tn=ae&tt=" + typeTree + "' sn='y'>upload file</a>";
        ...
        if (treeType.equals("tree")) {
            ...
            aeHtml = "<li id='liae_" + aeId + closeOpenHtml + aeId + "' >Analysis Event: " + name + " (" + status + ")" + "</span>"
                    + ownerHtml + END_HTML_EMPTY_NODE;
        }
        // html = html + aeHtml;
     ...
     * @return a {@link java.lang.String} object.
     */
    public static String getIUSHtml(IUS ius, Registration registration, String typeTree, String openingNodeId, boolean isOpenProc,
            boolean isVisibleProc, String treeType) {
        String html = "";
        ...
        for (Processing processing : processings) {
            ...
            if (openingNodeId != null && openingNodeId.equals(Constant.PROCESSING_PREFIX + processing.getProcessingId())) isOpenWfr = true;

            // dont show the workflow run in the first processing ?
            processing.setWorkflowRun(null);

            html = html
                    + getNodeHtml(processing, registration, typeTree, isOpenWfr, isOpenProc, isVisibleProc, true, isLast(countItem),
                            treeType);
        }
        return html;
    }

    private static String getOnlyIUSHtml(IUS ius, Registration registration, String typeTree, String openingNodeId, boolean isEnd,
            boolean isAssSample, boolean isAssLane, boolean isLast, String treeType) {
        ...
        if (registration.equals(ius.getOwner()) || registration.isLIMSAdmin()) {
            ...
            String assLaneLinkHtml = "<div class='m-associated'>Associated with sequence: " + "<a href='laneSetup.htm?laneId="
                    + lane.getLaneId() + "&tt=st' sn='y'>Sequnce SWID:" + lane.getSwAccession() + " " + laneName + "</a></div>";
            ...
            if (isAssSample && isAssLane) {
                ...
                String assSampleLinkHtml = "<b>Associated with sample:</b> <a href='sampleSetup.htm?sampleId=" + sample.getSampleId()
                        + "&tt=" + typeTree + "' sn='y'>Sample: " + sample.getJsonEscapeTitle() + " " + sample.getJsonEscapeName()
                        + " SWID:" + sample.getSwAccession() + " " + sampleName + "</a>";
                assLaneLinkHtml = "<b>Associated with sequence:</b> <a href='laneSetup.htm?laneId=" + lane.getLaneId() + "&tt=" + typeTree
                        + "' sn='y'>Sequence SWID:" + lane.getSwAccession() + " " + laneName + "</a>";
                ownerHtml = "<span class='m-link'> " + uploadFileLink + "- " + deleteLink + " &nbsp;- &nbsp;" + assSampleLinkHtml
                        + " &nbsp;- &nbsp;" + assLaneLinkHtml + "</span>";
            } else {
                ownerHtml = "<span class='m-link'> " + uploadFileLink + "- " + deleteLink + " - " + assLaneLinkHtml + " </span>";
            }
        }
        ...
        if (treeType.equals("tree")) {
            ...
            iusHtml = "<li id='liius_" + iusId + closeOpenHtml + iusId + "' >IUS: " + name + " SWID: " + swAccession + "</span>"
                    + ownerHtml + "</span>" + END_HTML_EMPTY_NODE;
        }
        return iusHtml;
    }
    ...
    // get html code all Processing in one Lane
    /*
     * public static String getLaneHtml(Lane lane, Registration registration, String typeTree, String openingNodeId, boolean isOpenProc,
     * boolean isVisibleProc){ String html = ""; Set<Processing> processings = lane.getProcessings(); int countItem = 0; for (Processing
     * processing : processings) { countItem++; boolean isOpenWfr = false; if(openingNodeId != null &&
     * openingNodeId.equals(processing.getProcessingId())) isOpenWfr = true;
     * 
     * // if last element boolean isLast = ( countItem == processings.size() ) ? true : false;
     * 
     * html = html + getNodeHtml(processing, registration, typeTree, isOpenWfr, isOpenProc, isVisibleProc, true, isLast); } return html; }
     */
    /**
     * <p>
     * getLaneHtml.
    ...
    public static String getLaneHtml(Lane lane, Registration registration, String typeTree, String openingNodeId, String treeType) {
        ...
        for (IUS ius : iuss) {
            countItem--;
            html = html + getOnlyIUSHtml(ius, registration, typeTree, openingNodeId, false, false, true, isLast(countItem), treeType);
        }
        return html;
    }
     ...
     * @return a {@link java.lang.String} object.
     */
    public static String getSampleHtml(Sample sample, Registration registration, String typeTree, String openingNodeId, boolean isEnd,
    ...
    private static String getOnlySampleHtml(Sample sample, Registration registration, String typeTree, String openingNodeId,
            boolean isLast, String treeType) {
        String html = "";
        ...
        if (registration.equals(sample.getOwner()) || registration.isLIMSAdmin()) {
            ...
            String deleteLink = "<a href='#' popup-delete='true' form-action='sampleDelete.htm' tt='st' object-id='" + sampleId
                    + "' object-name='Sample " + title + "'>delete</a>";
        ...
        boolean isHasChildren = (sample.getChildren().size() > 0 || sample.getIUS().size() > 0 || sample.getProcessings().size() > 0) ? true
                : false;
        String classLiHtml = getLiClass(true, isHasChildren, isLast);
        ...
        Log.info("	EQ Samples: openingNodeId = " + openingNodeId + " ; curr = " + Constant.SAMPLE_PREFIX + sampleId);
        ...
        if (treeType.equals("tree")) {
            ...
            html = "<li id='lisam_" + sampleId + closeOpenHtml + sampleId + "' >Sample: " + title + " SWID: " + sampleAccession + "</span>"
                    + ownerHtml + "</span>" + END_HTML_EMPTY_NODE;
        }
        return html;
    }
     ...
     * @return a {@link java.lang.String} object.
     */
    public static String getExperimentHtml(Experiment experiment, Registration registration, String typeTree, String openingNodeId,
            boolean isOpenProc, String treeType) {
        String html = "";
     ...
     * @return a {@link java.lang.String} object.
     */
    public static String getStydyHtml(Study study, Registration registration, String openingNodeId, boolean isOpenProc, String treeType) {
        String html = "";
        ...
        for (Experiment experiment : experiments) {
            ...
            try {
                if (registration.equals(experiment.getOwner()) || registration.isLIMSAdmin()) {
                    String editLink = "<a href='experimentSetup.htm?experimentId=" + expId + "&studyId=" + studyId + "' sn='y'> edit </a>";
                    String deleteLink = "<a href='#' popup-delete='true' form-action='experimentDelete.htm' tt='st' object-id='" + expId
                            + "' object-name='Experiment " + title + "'>delete</a>";
                    String addLink = "<a href='sampleSetup.htm?experimentId=" + expId + "&studyId=" + studyId + "' sn='y'> add sample</a>";
                    String uploadFileLink = "<a href='uploadFileSetup.htm?id=" + expId + "&tn=exp&tt=st' sn='y'>upload file</a>";
                    ownerHtml = "<span class='m-link'>" + editLink + " - " + deleteLink + " - " + addLink + " - " + uploadFileLink
                            + "</span>";
                }
            ...
            boolean isHasChildren = (experiment.getSamples().size() > 0 || experiment.getProcessings().size() > 0) ? true : false;
            String classLiHtml = getLiClass(true, isHasChildren, isLast);
     ...
     * @return a {@link java.lang.String} object.
     */
    public static String getSequencerRunHtml(SequencerRun sequencerRun, Registration registration, String openingNodeId, String treeType) {
        String html = "";
        ...
        for (Lane lane : lanes) {
            ...
            if (registration.equals(lane.getOwner()) || registration.isLIMSAdmin()) {
                ...
                for (Sample sam : samples) {
                    ...
                    assSampleLinksHtml = assSampleLinksHtml + " <a href='sampleSetup.htm?sampleId=" + sampleId + "&laneId=" + laneId
                            + "&tt=sr' sn='y'>Sample SWID:" + swAccessionSample + " " + sampleTitle + "</a>,";
                }
                assSampleLinksHtml = assSampleLinksHtml.substring(0, assSampleLinksHtml.length() - 1);
                assSampleLinksHtml = assSampleLinksHtml + "</div>";

                ownerHtml = "<span class='m-link'> " + editLink + " - " + deleteLink + " - " + uploadFileLink + " - " + assSampleLinksHtml
                        + " </span>";
            }
            ...
            if (treeType.equals("tree")) {
                ...
                laneHtml = "<li id='liseq_" + laneId + closeOpenHtml + laneId + "' >Sequence: " + name + " SWID: " + swAccession + statuses
     ...
     * @return a {@link java.lang.String} object.
     */
    public static String pasteHtmlIntoParentNode(String childHtml, String parentHtml, String parentId, boolean isChildVisible) {
        // opening parent node
        String visibleChildHtml = "<ul style=''>";
        if (!isChildVisible) visibleChildHtml = "<ul style='display: none;'>";
