...
public class AnalisysEventController extends MultiActionController {
     ...
     *             if any.
     */
    public ModelAndView handleDelete(HttpServletRequest request, HttpServletResponse response, WorkflowRun command) throws Exception {
     ...
     *             if any.
     */
    public ModelAndView handleShare(HttpServletRequest request, HttpServletResponse response, WorkflowRun command) throws Exception {
     ...
     *             if any.
     */
    public ModelAndView handleCancel(HttpServletRequest request, HttpServletResponse response, WorkflowRun command) throws Exception {
