...
/**
 * <p>
 * BulkDownloadListDetailsController class.
 * </p>
 * 
 * @author boconnor
 * @version $Id: $Id
...
public class BulkDownloadListDetailsController extends BaseCommandController {
    ...
    /**
     * <p>
     * Constructor for BulkDownloadListDetailsController.
     * </p>
     */
    ...
    protected ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (root == null || "".equals(root) || "source".equals(root)) {
            ...
            if (typeList.equals("bymesharelist")) {
                ...
                pageInfo = PaginationUtil.getPageInfo(request, "bulkDownloadSharedWithMe", listView, listAll, nameOneItem, nameLotOfItem,
                        ma);
            }
            ...
            /*
             * if(root.indexOf("seq_") != -1){ lane = getLaneService().findByID(Constant.getId(root));
             * BulkUtil.selectProcessingNode(selectedIds, lane); getProcessingService().setWithHasFile(lane.getProcessings()); }else
             */
        ...
        /*
         * if(root.indexOf("seq_") != -1){ System.err.println("RENDERING INDIVIDUAL Processing"); modelAndView = new
         * ModelAndView("StudyListProcessing"); modelAndView.addObject("lane", lane); // modelAndView.addObject("typeTree", "st"); }else
         */
        if (root.indexOf("sam_") != -1) {
