...
<div class="b-signup-form">
    ...
    <c:forEach items="${fixed}" var="expense">
        <table class="m-table-base">
            ...
            <tr><td>${expense.totalUnits} units @ $${expense.pricePerUnit} per unit = </td><td>$${expense.totalPrice}</td></tr>
        </table>
        <p/>
    </c:forEach>    
        <p>
    ...
    <h3>Analysis and Storage Expenses</h3>
    ...
    <table>
        ...
        <tr><td><b>Total Due:</b></td><td>$${total_due}</td></tr>
