...
<p>
This page allows you to show and edit Workflow Params.
</p>
...
<div class="b-signup-form">
	...
	<div class="b-sbmt-field">
		<a href="<c:url value="/workflowSetup.htm"/>" class="m-create-account">Add New Workflow Param</a>
		<span class="m-italic"><spring:message code="general.link.or"/></span>&nbsp;
        <a href="<c:url value="/manageWorkflows.htm"/>">Cancel</a>
    </div>
</div>
<!-- End Main Content -->
