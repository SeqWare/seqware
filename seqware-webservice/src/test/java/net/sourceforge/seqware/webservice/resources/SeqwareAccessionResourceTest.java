...
public class SeqwareAccessionResourceTest extends AbstractResourceTest {
    ...
    public SeqwareAccessionResourceTest() {
        super("/SWA");
    }
    ...
    public void testGet() {
        ...
        try {
            ...
            Assert.fail("SeqwareAccessionResourceTest.get " + e.getMessage());
            e.printStackTrace();
        } finally {
            resource.release();
        }
    ...
    public void testPost() {
        ...
        try {
            ...
            System.out.println("SeqwareAccessionResourceTest.post " + e.getMessage());
        } finally {
            resource.release();
        }
    }
...
//    @Override
    ...
    public void testDelete() {
        ...
        try {
            ...
            System.out.println("SeqwareAccessionResourceTest.del " + e.getMessage());
        } finally {
            resource.release();
        }
    }
