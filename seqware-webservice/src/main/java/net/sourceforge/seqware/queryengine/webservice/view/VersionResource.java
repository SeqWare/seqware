...
public class VersionResource extends ServerResource {
    ...
    /*
     * @Post public Representation accept(Representation entity) throws Exception { Representation rep = null; if (entity != null) { if
     * (MediaType.MULTIPART_FORM_DATA.equals(entity.getMediaType(),true)) { // 1/ Create a factory for disk-based file items
     * DiskFileItemFactory factory = new DiskFileItemFactory(); factory.setSizeThreshold(1000240);
     * 
     * // 2/ Create a new file upload handler based on the Restlet // FileUpload extension that will parse Restlet requests and // generates
     * FileItems. RestletFileUpload upload = new RestletFileUpload(factory); //ServletFileUpload upload = new ServletFileUpload(factory);
     * 
     * List<FileItem> items;
     * 
     * 
