...
public class MetadataDB {
 ...
 public String getFilePath(int accession) {
   ...
   * @param status a {@link java.lang.String} object.
   */
  public void updateWorkflowRun(int workflowRunAccession, String name, String cwd, String iniContents, String command, String workflowTemplate, WorkflowRunStatus status) {
    Connection c = setupConnection();
    Statement s = null;
