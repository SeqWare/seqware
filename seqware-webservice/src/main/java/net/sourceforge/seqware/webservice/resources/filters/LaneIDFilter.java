    ...
    public void getXml() {
        ...
        if (requestAttributes.containsKey("sequencerRunId")) {
            ...
            if (val != null) {
                ...
                SequencerRun s = (SequencerRun)testIfNull(ss.findBySWAccession(convertIntAttributeWithResourceException(val.toString())));
            ...
            if (val != null) {
                ...
                IUS s = (IUS)testIfNull(ss.findBySWAccession(convertIntAttributeWithResourceException(val.toString())));
