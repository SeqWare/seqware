    ...
    public void getXml() {
        ...
        if (requestAttributes.containsKey("laneId")) {
            ...
            if (val != null) {
                ...
                Lane s = (Lane)testIfNull(ss.findBySWAccession(convertIntAttributeWithResourceException(val.toString())));
            ...
            if (val != null) {
                ...
                Sample s = (Sample)testIfNull(ss.findBySWAccession(convertIntAttributeWithResourceException(val.toString())));
                iuss = (SortedSet<IUS>)testIfNull(s.getIUS());
            }
        } else {
