...
import io.seqware.webservice.model.Workflow;
...
public class WorkflowFacadeREST extends AbstractFacade<Workflow> {
  @PersistenceContext(unitName = "io.seqware_seqware-webservice_war_1.0-SNAPSHOTPU")
  private EntityManager em;

  public WorkflowFacadeREST() {
  ...
  @Path("{from}/{to}")
  @Produces({"application/xml", "application/json"})
  public List<Workflow> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
