...
public class TestClient {
	...
	private static void createStudy()
	{
		...
		if (genStudy.getStudyId() !=  (new ArrayList<StudyAttribute>(genStudy.getStudyAttributeCollection())).get(0).getStudyId().getStudyId() )
			throw new RuntimeException ("the persisted study Id does not match the Id of the study's attributes!");
